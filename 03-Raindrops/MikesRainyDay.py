...
class Cloud:
    ...
    def rain(self):
        ...
        new_rain_drop = Raindrop(self.screen, self.x + random.randrange(0,self.image.get_width()),self.y+self.image.get_height()-8)
        self.raindrops.append(new_rain_drop)
...
def main():
    ...
    screen = pygame.display.set_mode((1000,600))  ### Do not forget to save the screen
